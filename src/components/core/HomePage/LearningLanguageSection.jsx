    ...
    <div className='mt-[130px] mb-32'>
      <div className='flex flex-col gap-5 items-center'>
        ...
        <div className='flex items-center justify-center mt-5'>
            <img src={know_your_progess} alt="KnowYourProgess" className='object-contain -mr-32'/>
            <img src={compare_with_others} alt="CompareWithOthers" className='object-contain'/>
            <img src={plan_your_lesson} alt="PlanWithLesson" className='object-contain -ml-36'/>
        </div>
        <div className='w-fit'>
