            ...
            loading ? (<div className='spinner'></div>) :(<div className="max-w-[500px] p-4 lg:p-8" >
                ...
                <form onSubmit={handleOnSubmit}>
                    <label className="relative">
                       ...
                       />
                       <span onClick={() => setShowPassword((prev) => !prev)} className="absolute right-3 top-[28px] z-[10] cursor-pointer">
                            {
                              showPassword
                    ...
                    <label className="relative mt-3 block">
                       <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">Confirm New Password<sup sup className="text-pink-200">*</sup></p> 
                       <input
                        required
                        ...
                        className="form-style w-full !pr-10"
                       />
                       <span onClick={() => setShowConfirmPassword((prev) => !prev)} className="absolute right-3 top-[28px] z-[10] cursor-pointer">
                        {
                          showConfirmPassword ? (
                  <AiOutlineEyeInvisible fontSize={24} fill="#AFB2BF" />
                ) : (
